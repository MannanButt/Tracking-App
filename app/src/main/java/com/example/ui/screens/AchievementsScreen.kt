      ...
      Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Card(
          ...
          Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            LeaderboardPreviewRow(
              rank = "2",
              name = "Master Seeker (You)",
              xp = "${String.format("%.1fk", totalXp / 1000f)}",
              isSelf = true
            )
...
fun LeaderboardPreviewRow(
  ...
  Row(
    modifier = Modifier
      .fillMaxWidth()
      .background(
        color = if (isSelf) MaterialTheme.colorScheme.primary.copy(alpha = 0.08f) else Color.Transparent,
        shape = if (isSelf) RoundedCornerShape(12.dp) else RoundedCornerShape(0.dp)
      )
      .padding(vertical = 8.dp, horizontal = if (isSelf) 8.dp else 0.dp),
    verticalAlignment = Alignment.CenterVertically,
    horizontalArrangement = Arrangement.SpaceBetween
  ) {
    Row(verticalAlignment = Alignment.CenterVertically) {
      Text(
        ...
        fontSize = 14.sp,
        fontWeight = FontWeight.Bold,
        color = if (isSelf) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.onSurfaceVariant,
